...
#   --no-underperformers      Watchlist of traps lagging nearby same-type traps
...
- Underperforming traps: watchlist (dumbbell chart + table) of traps catching well below nearby traps of the same type
